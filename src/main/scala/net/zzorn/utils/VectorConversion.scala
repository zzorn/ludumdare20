...
object VectorConversion {
  ...
  implicit def vector2ToInVec2(v: Vector2f): inVec2 = Vec2(v.x, v.y)
  ...
  implicit def vector3ToInVec3(v: Vector3f): inVec3 = Vec3(v.x, v.y, v.z)
  ...
  implicit def colorToInVec4(v: ColorRGBA): inVec4 = Vec4(v.r, v.g, v.b, v.a)
