 ...
 * 
 */
// TODO: Write xorshift RNG for good, fast random numbers
object RandomUtils {
  ...
  def hslColor(spread: inVec4 = Vec4(0.5f, 0.5f, 0.5f, 0f),
    ...
    Colors.HSLtoRGB(clampedHsl.x, clampedHsl.y, clampedHsl.z, clampedHsl.w)
  }
  ...
  private val _rng = new Random()

  private def seededRng: Random = {
